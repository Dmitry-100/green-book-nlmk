...
- UI не использует DRM-подобные ограничения для лицензированных справочных материалов: штатное контекстное меню, открытие изображения и сохранение средствами браузера не блокируются

Важно: контроль доступа применяется только к непубличным пользовательским медиа наблюдений. Для публичных справочных материалов проект опирается на корректное основание использования, атрибуцию и реестр прав, а не на технический запрет скачивания.
